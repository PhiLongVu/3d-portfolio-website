...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      showAlert({ show: true, text: 'Your message has been sent successfully!', type: 'success' });
      setIsLoading(false);
      setTimeout(() => {
        hideAlert();
      ...
      showAlert({ show: true, text: 'An error occurred while sending your message. Please try again later.', type: 'danger' });
      setCurrentAnimation('idle');
      setIsLoading(false);
    });
  };
